...
> doesn't change. The old `webhook-platform/php` package still installs — it
> is now a metapackage that requires this one, with a deprecation notice in
> its README. Point Composer at `hookflow/php` going forward.
